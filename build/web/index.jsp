                                        ...
                                        <div class="main-menu">
                                            <nav class="d-none d-lg-block">
                                                <ul id="navigation">
                                                    ...
                                                    <li><a href="/demoSWP/home?indexx=1">Tìm công việc</a></li>
            ...
            <div class="our-services section-pad-t30">
                <div class="container">
                    ...
                    <div class="row d-flex justify-contnet-center">
                        <c:forEach items="${of.listOffice}" var="z" begin="0" end="0">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="office?idOffice=${z.idOffice}">${z.nameOffice}</a></h5>
                                        <span>(6)</span>
                                    </div>
                                </div>
                            </div>
                        </c:forEach>
                        <c:forEach items="${of.listOffice}" var="z" begin="3" end="3">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="office?idOffice=${z.idOffice}">${z.nameOffice}</a></h5>
                        ...
                        <c:forEach items="${of.listOffice}" var="z" begin="2" end="2">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="office?idOffice=${z.idOffice}">${z.nameOffice}</a></h5>
                        ...
                        <c:forEach items="${jo.listJobcate}" var="z" begin="0" end="0">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                        ...
                        <c:forEach items="${jo.listJobcate}" var="z" begin="1" end="1">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="category?idJobcate=${z.idJobcate}">${z.nameJobcate}</a></h5>
                        ...
                        <c:forEach items="${jo.listJobcate}" var="z" begin="2" end="2">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="category?idJobcate=${z.idJobcate}">${z.nameJobcate}</a></h5>
                        ...
                        <c:forEach items="${of.listOffice}" var="z" begin="4" end="4">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="office?idOffice=${z.idOffice}">${z.nameOffice}</a></h5>
                        ...
                        <c:forEach items="${jo.listJobcate}" var="z" begin="4" end="4">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                                <div class="single-services text-center mb-30">
                                    <div class="services-cap">
                                        <h5><a href="category?idJobcate=${z.idJobcate}">${z.nameJobcate}</a></h5>
